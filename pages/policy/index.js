...
export default function Policy() {
  return (
    <>
      <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r p-8">
        <div className="max-w-4xl mx-auto bg-default-100 p-6 rounded-lg shadow-lg">

          <h1 className="text-2xl font-bold mb-4">Privacy Policy</h1>
          <p className="text-sm text-default-200 mb-4">Last updated: November 13, 2024</p>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li className="mb-2 pl-5">
              <strong>Website</strong> refers to Doc-Classification, accessible from&nbsp;
              <a
                href="https://doc-classification.co.za"
                rel="external nofollow noopener"
                target="_blank"
                className="text-blue-600 underline"
              >
                https://doc-classification.co.za
              </a>
            </li>
            <li className="mb-2 pl-5">
          ...
          <h4 className="text-md font-semibold mb-2">1. Personal Data</h4>
          <p className="mb-4">
            While using Our Service, We may ask You to provide Us with certain personally identifiable information that can be used to contact or identify You. Personally identifiable information may include, but is not limited to:
          </p>

          <h4 className="text-md font-semibold mb-2">2. Usage Data</h4>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2 pl-5"><strong>With Service Providers:</strong> We may share Your personal information with Service Providers to monitor and analyze the use of our Service, to contact You.</li>
            <li className="mb-2 pl-5"><strong>For business transfers:</strong> We may share or transfer Your personal information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or acquisition of all or a portion of Our business to another company.</li>
            <li className="mb-2 pl-5"><strong>With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will require those affiliates to honor this Privacy Policy. Affiliates include Our parent company and any other subsidiaries, joint venture partners or other companies that We control or that are under common control with Us.</li>
            <li className="mb-2 pl-5"><strong>With business partners:</strong> We may share Your information with Our business partners to offer You certain products, services or promotions.</li>
            <li className="mb-2 pl-5"><strong>With other users:</strong> when You share personal information or otherwise interact in the public areas with other users, such information may be viewed by all users and may be publicly distributed outside.</li>
            <li className="mb-2 pl-5"><strong>With Your consent</strong>: We may disclose Your personal information for any other purpose with Your consent.</li>
          </ul>
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2 pl-5">Comply with a legal obligation</li>
            <li className="mb-2 pl-5">Protect and defend the rights or property of the Company</li>
            <li className="mb-2 pl-5">Prevent or investigate possible wrongdoing in connection with the Service</li>
            <li className="mb-2 pl-5">Protect the personal safety of Users of the Service or the public</li>
            <li className="mb-2 pl-5">Protect against legal liability</li>
          </ul>
          ...
          <ul className="list-disc list-inside mb-4">
            <li className="mb-2 pl-5">By email: zwangatm@gmail.com</li>
          </ul>
        </div>
      </div>
    </>
